    ...
    <section className='z-10 my-14'>
      <div className='container flex justify-center gap-[300px]'>
        ...
        <div className='w-full max-w-[440px]'>
          ...
          >
            <div className='electricianHeading text-xl font-semibold tracking-normal xl:text-2xl'>
              Бесплатная консультация
            </div>
            <div className='font-roboto mt-6 text-justify text-[16px] leading-4'>
      ...
      >
        ...
        <h3 className='mx-auto mt-4 max-w-[735px] text-center font-light tracking-[-0.035em] text-[#676767]'>
